...
# 加载 IID 数据
iid_users = np.load('../data/meituan/' + 'demo5_iid_users.npy', allow_pickle=True)
# 加载 OOD 数据
ood_users = np.load('../data/meituan/' + 'demo5_ood_users.npy', allow_pickle=True)
...
if args.ood_finetune:
    ...
    if args.model_name == 'COR':
        model = models.COR(mlp_q_dims, mlp_p1_dims, mlp_p2_dims, mlp_p3_dims, \
                           item_feature, adj, E1_size, args.dropout, args.bn, args.sample_freq, args.regs,
        ...
        if epoch % evaluate_interval == 0:  # 每隔一定轮次进行评估
            ...
            if valid_results[1][K] > best_recall:  # 根据召回率选择最佳模型
                ...
                if not args.ckpt is None:  # 如果指定了检查点，保存微调模型
                    torch.save(model,
                               '{}{}_{}_{}_{}_{}_{}_{}_{}_{}_{}lr_{}wd_{}bs_{}anneal_{}cap_{}CI_{}drop_{}_{}_{}_{}bn_{}freq_{}reg_{}_{}_ood_002.pth'.format(
                    ...
                    torch.save(model,
                               '{}{}_{}_{}_{}q_{}p11_{}p12_{}p2_{}p3_{}lr_{}wd_{}bs_{}anneal_{}cap_{}CI_{}drop_{}Z1_{}E2_{}Z2_{}bn_{}freq_{}reg_{}_{}_ood_002.pth'.format(
