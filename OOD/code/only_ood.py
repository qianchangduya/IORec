...
# parser.add_argument('--ckpt', type=str, default= r'E:\IPG-Rec-master\COR-main\code\models\COR_meituan_iid_[3000]q_[]p11_[1]p12_[]p2_[]p3_0.001lr_0.0wd_500bs_0anneal_0.1cap_1CI_0.5drop_500Z1_1000E2_200Z2_0bn_1freq_0.0reg_tanh_log_ood_002.pth', help='pre-trained best iid model path')
...
# 用户分类
# iid_users, ood_users = user_demo5.classify_users(train_data, test_x_data, user_feature)
##########################
...
##########################
user_feature_euclidean, user_feature_difference = user_demo5.calculate_user_feature_change(user_feature, ood_user_feature)
interaction_jaccard_sim, interaction_difference = user_demo5.calculate_interaction_change(train_data.toarray(), test_x_data.toarray())
# 阈值选择（动态选择基于分位数）
...
iid_users, ood_users = user_demo5.classify_users(user_feature_euclidean, user_feature_difference,
